...
\t\t\t<span tabindex=\"0\" data-placement=\"right\" data-container=\"body\" role=\"button\" data-toggle=\"popover\" data-trigger=\"focus\" data-content='Тема' class=\"explain-popover\">";
            // line 9
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_ideographic_terms", [], "any", false, false, true, 9), 9, $this->source), "html", null, true);
            echo "</span>
\t\t</div>
\t";
        }
...
";
    ...
    {
        return array (  71 => 12,  65 => 9,  62 => 8,  60 => 7,  56 => 6,  51 => 5,  44 => 3,  42 => 2,  39 => 1,);
    }
